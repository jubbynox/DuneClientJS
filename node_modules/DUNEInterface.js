...
DUNEInterface.prototype.getMediaType=function(err, res, body, itemInfo){
    ...
    console.log("getMediaType itemInfo: %j", itemInfo);
    console.log("getMediaType body: %j", body);
    var path=`http://${this.folderParameters.Server.IP}:${this.folderParameters.Server.PORT}/mediabrowser/Videos/${body.Items[0].Id}/stream.mp4`;
...
DUNEInterface.prototype.playDune=function(startposition, type, url){
   // console.log(type);
    ...
    //http://192.168.1.10:8096/mediabrowser/Videos/008c4e46654d1396ebd2b3b112427dc5/stream.mp4
    /*request({
        url:fullUrl,
        method:'get',
        json:true}, function(err){
          if(err){
